--- 
title: "Caddo retouch results in convergent morphology for Jowell knives from 41AN13 and 41HS261 in the American Southeast"
author: 
...
Jowell knives from 41AN13 and 41HS261 comprise the two largest samples of this ill-understood lithic type from the ancestral Caddo area. All are thought to have been manufactured using Edwards chert, and acquired by the Caddo through trade with central Texas groups. Due to the very real possibility that these knives bear two discrete knapping signatures, the sample from each site was subset into two size classes reflective of original manufacture (longer), and local Caddo retouch efforts (shorter). These categories were used to assess whether local Caddo retouch practices resulted in similar---convergent---shapes in the smaller size class, and to test the hypothesis that greater shape variation would be apparent in the larger size class due to the influence of Caddo selective preference. The analysis of linear variables demonstrated that large and small Jowell knives differ in thickness between sites, where those from 41HS261 are thicker in both size classes, suggestive of a local preference for thicker knives. The geometric morphometric analysis demonstrated that while the shape of Jowell knives from the large size class differed between sites, the small size class did not, supporting the argument for convergent morphology associated with local Caddo retouch. The analysis of morphological disparity in Jowell knife shape yielded support to the argument for greater shape diversity associated with Caddo selective preference, where the shape of Jowell knives becomes more standardized through Caddo retouch.
