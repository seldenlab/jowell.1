...
All elliptical bifaces were oriented with the most heavily retouched area at top right (see below). The landmarking protocol uses three landmarks; two horizontal tangents (top/bottom), and one placed at the furthest extent of the area that includes the heaviest amount of retouch. Note that bifaces b, c, d, and e have the most heavily retouched edges at the top and bottom of the right lateral edge, and biface f includes one area of retouch located at the top right and another at bottom left. To identify which of these areas was most heavily retouched, we employed a modified approach to the flaking index initially developed by Miller [-@RN11459], and later advanced and refined by Smallwood [-@RN8310], then Miller and Smallwood [-@RN11460]. The modified approach enlisted counts of flake scars on each face of the most heavily worked two areas, paired with a measure of edge length (performed in ImageJ). The number of flake scars was divided by the length of the worked area, and the heaviest worked area was identified by the greater value.
...
The shape of elliptical bifaces does not differ significantly in either size class; however, size does. While not rising to the level of significance, the graphic associated with the phenotypic trajectory analysis illustrates morphological divergence, a claim that is also supported by the results of the Procrustes ANOVA. Results for the analysis of morphological disparity yielded support for the interpretation that greater morphological diversity is associated with resharpening and/or retouch, instead of production/manufacture. As the bifaces are reworked to meet the variable needs of Caddo users, morphology diverges.
