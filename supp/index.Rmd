--- 
title: "Jowell knife reduction practices result in discrete shape difference between Caddo sites in the American Southeast"
author: 
...
Jowell knives from 41AN13 and 41HS261 comprise the two largest samples from the ancestral Caddo area, providing those data needed to assess local differences in linear and shape variables potentially related to differential retouch practices. Findings demonstrate that knives from 41HS261 are both thicker and less broad than those from 41AN13, potentially indicative of differences in retouch or manufacture. Analysis of the flaking index demonstrates that knives from 41HS261 are more heavily retouched than those from 41AN13. 
