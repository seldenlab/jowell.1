...
Jowell knives from 41AN13 and 41HS261 comprise the two largest samples of this ill-understood lithic type from the ancestral Caddo area. All are thought to have been manufactured using Edwards chert, and acquired by the Caddo through trade with central Texas groups. Due to the very real possibility that these knives evince two discrete knapping signatures, the sample from each site was divided into two size classes reflective of central Texas manufacture (longer) and Caddo resharpening and/or retouch (shorter). These categories were used to assess whether modifications by Caddo knappers resulted in similar---convergent---shapes in the smaller size class, and to test the hypothesis that greater shape variation would be apparent in the larger size class due to the influence of Caddo selective preference. Both large and small size classes were found to be significantly thicker at 41HS261, suggesting a local preference for thicker knives. The geometric morphometric analysis demonstrated that while the shape of Jowell knives from the large size class differed between sites, the small size class did not, furthering the argument for convergent morphology. The analysis of morphological disparity yielded support for the argument that greater shape diversity is associated with Caddo selective preference, as well as the hypothesis that Jowell knife shape converges---becoming locally standardized---through the resharpening and/or retouch practices of Caddo knappers.
