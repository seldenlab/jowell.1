...
Jowell knives from 41AN13 and 41HS261 comprise the two largest samples from the ancestral Caddo area. All knives in the sample were manufactured using Edwards chert, and are thought to have been acquired by the Caddo through trade with central Texas groups. The sample from each site was subset into large and small groups, reflective of original manufacture (large), and local Caddo resharpening efforts (small). These categories were used to assess whether Caddo resharpening practices resulted in similar---convergent---morphologies among the small knives. It was also hypothesized that greater shape variation would be apparent at their larger size due to the influence of non-local manufacturing practices as well as Caddo selective preference. Results of the analysis of linear variables demonstrated that large and small Jowell knives differ in thickness between both sites, where those from 41HS261 are thicker in both instances. The geometric morphometric analysis demonstrated that while the shape of Jowell knives from the large size class differed between sites, the small size class did not, providing support for the argument for convergent shape change thought to articulate with local Caddo retouch or resharpening efforts. The analysis of morphological disparity supports the argument for greater diversity in Jowell knife shape in the larger size class at 41AN13, suggesting a greater variety of shapes associated with manufacture that became increasingly standardized through local Caddo resharpening and/or retouch efforts.
