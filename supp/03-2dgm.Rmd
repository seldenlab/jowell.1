...
shapesGM <- readland.shapes(shapes, nCurvePts = c(15, 30, 45))
...
A phenotypic trajectory analysis [@RN8344;@RN8550;@RN8569;@RN8533;@RN8446] was used to assess whether reduction/retouch trajectories differ between the sites. 
